//
//  ChargingBoardHeader.h
//  ChargingBoard
//
//  Created by iMokhles on 25/02/2017.
//
//

#ifndef ChargingBoardHeader_h
#define ChargingBoardHeader_h
...
//+ (id)callToActionLabel; // not exist in iOS 10.1 and above
+ (id)tinting;
+ (id)wallpaper;
+ (id)slideableContent;
+ (id)pageContent;
